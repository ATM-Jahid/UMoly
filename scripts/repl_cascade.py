...
parser.add_argument('-x', '--xdim', default=160, metavar='', help='x dimension length (lattice unit)', type=int)
parser.add_argument('-y', '--ydim', default=160, metavar='', help='y dimension length (lattice unit)', type=int)
parser.add_argument('-z', '--zdim', default=80, metavar='', help='z dimension length (lattice unit)', type=int)
parser.add_argument('-M', '--moly', default=0.22, metavar='', help='molybdenum portion', type=float)
parser.add_argument('-X', '--xenon', default=328, metavar='', help='number of Xe atoms', type=int)
parser.add_argument('-r', '--bRad', default=20, metavar='', help='bubble radius (box unit)', type=float)
parser.add_argument('-s', '--bShl', default=10, metavar='', help='bubble shell width (box unit)', type=float)
...
jar = jar.replace('__OFFCENT_DIST', f'{args.offcent}', 1)
