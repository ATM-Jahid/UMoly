...
pair_style	adp
pair_coeff	* * /home/atomsky/builds/UMoly/potentials/U_Mo.alloy.adp U Mo
...
fix		av1 all ave/time 1 10 25 v_T v_E v_V v_Pr v_Lx v_Ly v_Lz v_c1 v_c2 file relax.GRAIN
...
#if		"${Rand} > ${PercMo}" then "variable inType equal 1" else "variable inType equal 2"
#
#region		stitial block EDGE EDGE -2 2 EDGE EDGE side in units box
#fix		extra all deposit 1 ${inType} 1 ${seed} region stitial near 2.0 attempt 10 units box
#
#run		100
#unfix		extra
...
fix		mesdi1 all ave/time 1 5 100 c_uMsd[1] c_uMsd[2] c_uMsd[3] c_moMsd[1] c_moMsd[2] c_moMsd[3] c_allMsd[1] c_allMsd[2] c_allMsd[3] file msdxyz.GRAIN
fix		mesdi2 all ave/time 1 5 100 v_T v_E v_V v_Pr v_c1 v_c2 c_uMsd[4] c_moMsd[4] c_allMsd[4] file msd.GRAIN
